        ...
        <div className='relative min-h-screen bg-white'>
            ...
            {loading && (
                <div className="fixed inset-0 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm z-50">
                    ...
                    <p className="text-gray-600 text-sm">Sending reset link...</p>
                </div>
            )}
                    ...
                    <div className='flex justify-center mb-6'>
                        <div className='w-16 h-16 rounded-2xl bg-indigo-50 border border-indigo-200 flex items-center justify-center'>
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
                                <rect x="4" y="11" width="18" height="13" rx="3" stroke="#6366F1" strokeWidth="1.5"/>
                                <path d="M8 11V8a5 5 0 0110 0v3" stroke="#4F46E5" strokeWidth="1.5" strokeLinecap="round"/>
                                <circle cx="13" cy="17" r="1.5" fill="#6366F1"/>
                                <line x1="13" y1="18.5" x2="13" y2="21" stroke="#6366F1" strokeWidth="1.5" strokeLinecap="round"/>
                            </svg>
                        </div>
                    </div>
